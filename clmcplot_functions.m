...
uicontrol('Parent',ptr, ...
'Units','pixels', ...
'Callback','global MRDS;axes(MRDS.axes(MRDS.n_subplots));ht=title(sprintf(''%s (%s)'',MRDS.fname,datestr(now,0)));orient landscape; print(MRDS.dptr,''-dpdf'',''-bestfit'',sprintf(''%s.pdf'',ht.String));',...
