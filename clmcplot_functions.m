...
uicontrol('Parent',ptr, ...
'Units','pixels', ...
'Callback','global MRDS;axes(MRDS.axes(MRDS.n_subplots));title(sprintf(''%s (%s)'',MRDS.fname,datestr(now,0)));orient landscape; print -bestfit -f451;',...
...
uicontrol('Parent',ptr, ...
'Units','pixels', ...
'Callback','global MRDS;axes(MRDS.axes(MRDS.n_subplots));ht=title(sprintf(''%s-%s'',MRDS.fname,datestr(now,''yyyy.mm.dd.HH.MM'')));orient landscape; print(MRDS.dptr,''-dpng'',''-r300'',sprintf(''%s.png'',ht.String));',...
...
uicontrol('Parent',ptr, ...
'Units','pixels', ...
'Callback','global MRDS;if MRDS.zoom<2500,MRDS.zoom=MRDS.zoom*1.5;end;clmcplot_functions(''zoom'');',...
'BackgroundColor',[0.9 0.9 0.5], ...
